// Right now we are loading everything from the server. While that is 'ok' to do that.
// But we can improve customer experience by loading static data for genres, platforms since they rarely change.
